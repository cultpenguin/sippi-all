...
%use_upscale=1;
if use_upscale==1;
    %id=id+1;d{id}=load('mps_entropy_data_n_cond_1_nx9.mat');
    %id=id+1;d{id}=load('mps_entropy_data_n_cond_5_nx9.mat');
    %id=id+1;d{id}=load('mps_entropy_data_n_cond_10_nx9.mat');
    %id=id+1;d{id}=load('mps_entropy_data_n_cond_15_nx9.mat');
